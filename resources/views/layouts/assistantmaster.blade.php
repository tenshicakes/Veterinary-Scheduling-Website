...
<body class="bg-background text-gray-800 font-sans" x-data="{ sidebarOpen: false }">
    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-72 bg-white shadow-[8px_0_30px_rgba(0,0,0,0.12)] transform transition-transform duration-300 flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('assistant.home') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-lg text-primary bg-blue-50 hover:bg-blue hover:text-white transition">
                <!-- Lucide Home Icon -->
            ...
            <a href="{{ route('assistant.appointments') }}" class="flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-lg text-primary hover:bg-blue hover:text-white transition">
            ...
            <a href="#" class="flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-lg text-primary hover:bg-blue hover:text-white transition">
                <!-- Lucide User Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
